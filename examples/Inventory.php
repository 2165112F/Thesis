              ...
              <div class="update ml-auto mr-auto">
                ...
                <div class="addNewItem" id="myForm" >
                    ...
                    <option value = "" disabled selected>Select Category</option>
										<option value="wet goods" required>Wet Goods</option>
										<option value="dry goods" required>Dry Goods</option>
										<option value="groceries" required>Groceries</option>
										<option value="can goods" required>Can Goods</option>
                  </select>
									</td>
								</tr>
								<tr>
                    ...
                    <option value="lbs" required>lbs</option>
                    <option value="Piece/s" required>Piece/s</option>
                    <option value="gal" required>gal</option>
                  </select>
